    ...
    return (
        <div className="space-y-5">
            ...
            <AdminFormSection title="Identidade visual">
                <AdminImageUploader label="Logo" preset="logo" value={data.logo} onChange={(v) => set("logo", v)} description="Logo principal da loja" />
                <AdminImageUploader label="Logo (Dark Mode)" preset="logo" value={data.logo_dark} onChange={(v) => set("logo_dark", v)} description="Versão opcional para fundos escuros" />
                <AdminImageUploader label="Favicon" preset="favicon" value={data.favicon} onChange={(v) => set("favicon", v)} description="Ícone da aba do navegador" />
            </AdminFormSection>
