                    ...
                    <div className="relative h-full container-boutique flex items-center">
                        <div className="max-w-xl text-bone animate-fade-rise">
                            ...
                            <div className="mt-9 flex flex-wrap gap-3">
                                <Link to={hero.button_link || hero.primary_cta_link || "/novidades"} className="inline-flex items-center gap-2 bg-[hsl(var(--gold))] text-white text-[11px] uppercase tracking-[0.22em] px-8 py-4 transition-all duration-500 hover:bg-[hsl(var(--gold))]/85">
